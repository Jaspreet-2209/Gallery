...
import "./modal.css";
import img1 from "./images/Frame 1000002294.png";
import img2 from "./images/Rectangle 39335.png";
  ...
  return (
    <div>
      <div className=" f1 h-[825px] top-[-1468px] left-[-910px] gap-0 bg-[linear-gradient(180deg,#373E44_-100%,#191B1F_100%)]">
        ...
        <img className='g1a' src={img1} alt="img1"></img>
      <img className='g1b' src={img2} alt="img2"></img>
          <div className="f3a">
            <div className="f3a11">
              <div className="f3b">
        ...
        <img className='g1c' src={img3} alt="img3"></img> 
        </div>
      ...
      <img className='g1d' src={img3} alt="img3"></img> 
      </div>
  );
}
